...
var btcMarketsCommissionRates = ExchangeCommissionRates(rates: [BTC: 0.001])

let btcMarkets = Exchange(name: "BTC Markets", instruments: [BTCUSD], commissionRates: btcMarketsCommissionRates )
