...
class TradeView: UIView
{
    ...
    @IBInspectable var instrumentCode: String? {
        didSet {
            instrumentCodeField.text = instrumentCode
        }
    }
    ...
    @IBOutlet weak var instrumentCodeField: UILabel!
    ...
    override func drawRect(rect: CGRect) {
        let path = UIBezierPath(ovalInRect: CGRectMake(20, 20, 150, 120))
